...
import com.yingke.widget.pulltorefresh.TabListView;
...
public class PullToRefreshTabListView extends PullToRefreshAdapterViewBase<TabListView> {
	...
	public PullToRefreshTabListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initFooter(context);
		init();
	}

	public PullToRefreshTabListView(Context context, Mode mode) {
		super(context, mode);
		initFooter(context);
		init();
	}

	public PullToRefreshTabListView(Context context, Mode mode, AnimationStyle style) {
	...
	protected TabListView createListView(Context context, AttributeSet attrs) {
		final TabListView lv;
	...
	@Override
	protected TabListView createRefreshableView(Context context, AttributeSet attrs) {
		TabListView lv = createListView(context, attrs);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshTabListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);

			return returnValue;
		}
	}

	protected class InternalListView extends TabListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshTabListView.this.setEmptyView(emptyView);
		}
	...
	private void init() {
		setOnScrollListener(getRefreshableView());
	}
