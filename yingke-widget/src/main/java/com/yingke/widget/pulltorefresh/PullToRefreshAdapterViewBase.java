...
import com.yingke.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	protected boolean mListViewExtrasEnabled = false;
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if ((!mListViewExtrasEnabled && mRefreshableView.getFirstVisiblePosition() == 0)
					|| (mListViewExtrasEnabled && mRefreshableView.getFirstVisiblePosition() <= 1)){
