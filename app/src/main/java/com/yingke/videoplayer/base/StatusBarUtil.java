...
/**
 * Created by liuguansheng on 2017/5/8.
 */
public class StatusBarUtil {
     ...
     */
    public static void setTransStatusBar(Activity activity, boolean isLightStatusBar) {
    ...
    public static int StatusBarLightMode(Activity activity, boolean dark) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.M && MIUISetStatusBarLightMode(activity.getWindow(), dark)) {
                result = 1;
